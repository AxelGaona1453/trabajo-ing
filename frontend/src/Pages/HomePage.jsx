		...
		<div className="min-h-screen bg-gray-50 font-sans">
				...
				<div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
					<div className="md:w-1/2 md:pr-10">
						...
						<p className="text-xl text-gray-300 mb-6">
							Aplicando principios de ingeniería rigurosos para construir sistemas de
							software confiables, escalables y seguros.
						</p>
			...
			<div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
				...
				<Section title="1. ¿Qué es la Ingeniería de Software?" icon={Cpu}>
					<p>
						Es una disciplina que aplica principios científicos, matemáticos y de
						ingeniería en el **diseño, desarrollo, implementación y mantenimiento de
						software**.
					</p>
					<p>
				...
				<Section title="2. ¿Cómo y cuándo surgió?" icon={Aperture}>
					<p className="mb-4 font-medium">
						Surgió como respuesta a la **"Crisis del Software"** en los 60s y 70s, cuando
						los proyectos enfrentaban problemas graves:
					</p>
				...
				<Section title="3. Objetivos de la Ingeniería de Software" icon={Package}>
					<p className="text-center font-semibold text-emerald-700 mb-6">
						La meta es estandarizar la producción de código de calidad y minimizar
						riesgos.
					</p>
					<div className="grid md:grid-cols-2 gap-6">
						{[
							...
							>
								<ShieldCheck className={`w-6 h-6 ${item.color} mr-3 flex-shrink-0`} />
				...
				<Section title="4. Áreas principales" icon={Edit}>
					<p>
						La ingeniería de software se divide en fases clave que garantizan el ciclo de
				...
				<div className="max-w-7xl mx-auto">
					<Section title="5. Herramientas utilizadas" icon={Zap} className="max-w-full">
						<p className="mb-6 italic text-gray-600">
							La disciplina usa herramientas según la etapa de desarrollo. Estas son
							algunas de las más populares por categoría:
						</p>
				...
				<Section title="7. Importancia" icon={ShieldCheck}>
					<ul className="space-y-3 p-4 bg-emerald-50 rounded-lg border border-emerald-300">
						<li className="flex items-start font-medium text-gray-800">
							<span className="text-emerald-600 text-2xl mr-3 font-bold">✓</span> Reduce
							los riesgos técnicos y comerciales.
						</li>
						<li className="flex items-start font-medium text-gray-800">
							<span className="text-emerald-600 text-2xl mr-3 font-bold">✓</span> Permite
							trabajar en equipos grandes de forma organizada.
						</li>
						<li className="flex items-start font-medium text-gray-800">
							<span className="text-emerald-600 text-2xl mr-3 font-bold">✓</span>{' '}
							Garantiza productos confiables y escalables.
						</li>
						<li className="flex items-start font-medium text-gray-800">
							<span className="text-emerald-600 text-2xl mr-3 font-bold">✓</span> Permite
							resolver problemas complejos del mundo real de manera eficiente.
						</li>
					</ul>
				</Section>
				...
				<Section title="8. Ejemplos de aplicaciones" icon={Code}>
					<p className="mb-4">
						Prácticamente todos los sistemas digitales son fruto de la Ingeniería de
						Software:
					</p>
				...
				<Section title="9. Conclusión" icon={Cpu}>
					<p className="text-center text-xl font-bold text-gray-900 p-4 border border-emerald-500 rounded-xl bg-emerald-100 shadow-lg">
						...
						construyen sistemas complejos y confiables que impactan todos los aspectos de
						la vida moderna, asegurando calidad, eficiencia y escalabilidad.
					</p>
				</Section>
			</div>
		</div>
...
const TimeBox = ({ year, event, icon: Icon, highlight = false }) => {
	...
	const baseClasses = `p-3 rounded-lg border-2 ${
		highlight ? 'bg-emerald-100 border-emerald-500 shadow-lg' : 'bg-white border-gray-200'
	} transition-all duration-1000 ease-out text-sm`;
	const animationClasses = isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-90';
